...
export const translations = {
  en: {
    ...
    pickupClothes: "Visit Tailor Location",
    pickupClothesDesc: "Go to the tailor's listed address for stitching and collect your finished clothes there.",
  ...
  hi: {
    ...
    pickupClothes: "दर्जी के पते पर जाएं",
    pickupClothesDesc: "सिलाई के लिए दर्जी के दिए हुए पते पर जाएं और तैयार कपड़े वहीं से लें।",
